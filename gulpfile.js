...
function devStyles() {
  ...
  return (
    src('./src/css/main.css')
      ...
      .pipe(postcss([tailwindcss(options.config.tailwindjs), require('autoprefixer'), require('postcss-preset-env')]))
...
function watchFiles() {
  ...
  watch([options.config.tailwindjs, `${options.paths.src.css}/**/*`], devStyles);
  // watch(`${options.paths.src.js}/**/*.js`, series(devScripts, previewReload));
  watch(`${options.paths.src.img}/**/*`, series(devImages, previewReload));
  watch('**/*.php').on('change', previewReload);
