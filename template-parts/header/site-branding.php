...
<div class=" site-branding text-center mx-auto">
  ...
  <h1
    class="text-center text-4xl sm:text-5xl lg:text-7xl md:text-6xl font-extrabold xl:text-8xl 2xl:text-9xl <?php echo esc_attr($header_class); ?>">
