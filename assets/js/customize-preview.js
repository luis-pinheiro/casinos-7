/* global casinos7GetHexLum, jQuery */
(function () {
  // Add listener for the "background_color" control.
  wp.customize('background_color', function (value) {
    value.bind(function (to) {
      var lum = casinos7GetHexLum(to),
        isDark = 127 > lum,
        ...
        stylesheetID = 'casinos7-customizer-inline-styles',
        stylesheet,
        styles;
      ...
      if (!stylesheet.length) {
        jQuery('#casinos-7-style-inline-css').after('<style id="' + stylesheetID + '"></style>');
        stylesheet = jQuery('#' + stylesheetID);
      }
