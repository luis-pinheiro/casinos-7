...
if (!class_exists('CASINOS_7_Customize')) {
	/**
	 * Customizer Settings.
	 *
	 * @since casinos7 1.0
	 */
	class CASINOS_7_Customize
	{
		...
		public function register($wp_customize)
		{
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__('Display Site Title & Tagline', 'casinos7'),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__('Excerpt Settings', 'casinos7'),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__('On Archive Pages, posts show:', 'casinos7'),
					'choices' => array(
						'excerpt' => esc_html__('Summary', 'casinos7'),
						'full'    => esc_html__('Full text', 'casinos7'),
					),
				)
			);
			...
			include_once get_theme_file_path('classes/class-casinos-7-customize-color-control.php'); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type('CASINOS_7_Customize_Color_Control');
			...
			$wp_customize->add_control(
				new CASINOS_7_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x('Background color', 'Customizer control', 'casinos7'),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
